...
var app = (function () {
    ...
    // (58:4) {#each passwords as pw, i (pw)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 59, 6, 1566);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(58:4) {#each passwords as pw, i (pw)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 27, 0, 560);
    			add_location(p, file, 29, 0, 581);
    			add_location(li0, file, 32, 2, 615);
    			add_location(li1, file, 33, 2, 692);
    			add_location(li2, file, 37, 2, 818);
    			add_location(li3, file, 40, 2, 910);
    			add_location(li4, file, 41, 2, 982);
    			add_location(li5, file, 42, 2, 1061);
    			add_location(ol, file, 31, 0, 608);
    			attr_dev(input, "type", "password");
    			add_location(input, file, 46, 2, 1143);
    			add_location(button, file, 47, 2, 1200);
    			add_location(ul, file, 56, 2, 1456);
    			add_location(div, file, 45, 0, 1135);
    		},
