...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 14, 4, 323);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 54, 2, 1406);
    			attr_dev(main, "class", "svelte-14fgpj0");
    			add_location(main, file, 53, 0, 1397);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let meetups = [
    		{
    			...
    			description: '13hour Svelte Course',
    			imageUrl: 'https://images.unsplash.com/photo-1593720213428-28a5b9e94613?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80',
    			address: '273',
    			contactEmail: 'www@dot.com'
    		},
    		{
    			id: 'm2',
    			title: 'React',
    			subtitle: 'Learn React',
    			description: 'How to code React',
    			...
    			address: '123',
    			contactEmail: 'react@facebook.com'
    		}
    	];
    	...
    	const input_handler = title => event.target.value;
    	const input_handler_1 = subtitle => event.target.value;
    	const input_handler_2 = address => event.target.value;
    	const input_handler_3 = imageUrl => event.target.value;
    	const input_handler_4 = email => event.target.value;
    	const input_handler_5 = description => event.target.value;
